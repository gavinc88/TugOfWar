...
public class MainActivity2 extends Activity implements OnClickListener, SensorEventListener {
  ...
  public void onSensorChanged(SensorEvent event) {
    if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
      ...
      if (last_x != 0 && last_y != 0 && last_z != 0 && (last_x != x || last_y != y || last_z != z)) {
        ...
        dataPoints.add(dp);
        //System.out.println("curTime: "+curTime + "  lastUpdate: " +lastUpdate);
...
//          }
//          if(directionChanged){
//            System.out.println("shake detected at speed: " + speed + "   y: " + y );
//          }
//
//        }
//
...
//    }
  ...
  private static final long KEEP_DATA_POINTS_FOR = 1000;
